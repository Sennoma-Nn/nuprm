export module nuprm-theme {
    def get-color [color] {
        ...
        let colors = {
            ...
            green: (color-to-ansi 80 161 79 "fg" "32"),
            red: (color-to-ansi 228 86 73 "fg" "31"),
            reset: (ansi reset)
        }
    ...
    export def get-prompt-command-left [] {
        ...
        let path_info = surround (get-prompt-info path -u $path_sep -d $"($status_color)" -s $"(get-color white)" -u) -r "\e[0m"
